#define ASSIGNMENT "HW #15.1: Ken Pottebaum \n"
...
FILE * UseFileWr(char *pFilename, int nLen) {
	FILE *fp;
	char *pc, *pChars="acoq", ch='c', sMode[2][3]={"wb","ab"};
	...
	return (ch!='q') ? fopen(pFilename,sMode[ch=='a']): NULL; // changes file mode to "ab" if append was selected.
}
